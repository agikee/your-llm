...
import { Send, Sparkles, RotateCcw, Save, Download, ChevronDown } from 'lucide-react';
...
function ProgressDots({ currentPhase }: { currentPhase: Phase }) {
  ...
  return (
    <div 
      ...
      aria-label={`Discovery progress: ${phases[currentIndex]} phase (${currentIndex + 1} of ${phases.length})`}
    >
      {phases.map((phase, i) => {
        ...
        return (
          <div key={phase} className="flex items-center gap-2">
            ...
            <span className={`text-xs font-medium tracking-wide uppercase transition-colors hidden sm:inline ${
              isCurrent ? 'text-warm-400' : 'text-deep-400'
            }`}>
              {phase}
            </span>
            {i < phases.length - 1 && (
...
`;
  ...
  // Completion screen with share card and context display
  if (currentPhase === 'complete' && contextModules) {
    return (
      <div id="main-content" role="main" className="fixed inset-0 bg-deep-950 flex flex-col overflow-hidden">
        {/* Background effects */}
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl sm:text-2xl font-serif font-semibold text-warm-100">
                  Your Discovery Complete
                </h1>
                <p className="text-sm text-deep-400">
                  Share your results or explore your AI context
                </p>
              </div>
            </div>
          </div>
        ...
        {/* Content - Share Card + Context Display */}
        <div ref={scrollRef} className="relative flex-1 overflow-y-auto no-scrollbar py-8 sm:py-12 px-4">
          <div className="max-w-6xl mx-auto">
            ...
            >
              <ShareCard
                discoveryData={{
                  compass: discoveryData?.compass || { value: '' },
                  engine: discoveryData?.engine || { beautifulProblem: '' },
                  toolkit: discoveryData?.toolkit || { instinct: '' },
                }}
            ...
            >
              <div className="h-px flex-1 bg-gradient-to-r from-transparent via-deep-700 to-transparent" />
              <div className="flex items-center gap-2 text-deep-400">
                <ChevronDown className="w-4 h-4" />
                <span className="text-xs uppercase tracking-wider">Your AI Context</span>
                <ChevronDown className="w-4 h-4" />
              </div>
              <div className="h-px flex-1 bg-gradient-to-r from-transparent via-deep-700 to-transparent" />
            </motion.div>
        ...
        <div className="relative flex-shrink-0 p-4 sm:p-6 border-t border-deep-800/50">
          <div className="max-w-4xl mx-auto flex items-center justify-center gap-4">
            <motion.button
              ...
              aria-label="Start discovery over"
            ...
            <motion.button
              ...
              aria-label="Download your AI context"
  ...
  if (currentPhase === 'complete' && isGeneratingContext) {
    return (
      <div id="main-content" role="main" className="fixed inset-0 bg-deep-950 flex flex-col items-center justify-center px-6 overflow-hidden">
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-warm-500/10 rounded-full blur-3xl" />
          <div className="absolute bottom-1/4 right-1/4 w-56 sm:w-80 h-56 sm:h-80 bg-sage-400/10 rounded-full blur-3xl" />
        </div>
      ...
      <div id="main-content" role="main" className="fixed inset-0 bg-deep-950 flex flex-col items-center justify-center px-6 overflow-hidden">
        <div className="relative text-center max-w-md">
          ...
          <motion.button
            ...
            aria-label="Retry generating your context"
    ...
    return (
      <div id="main-content" role="main" className="fixed inset-0 bg-deep-950 flex flex-col items-center justify-center px-6 overflow-hidden">
        ...
        >
          ...
          <p className="text-xs sm:text-sm text-deep-400 mt-6 sm:mt-8">
  ...
  return (
    <div id="main-content" role="main" className="fixed inset-0 bg-deep-950 flex flex-col overflow-hidden">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto no-scrollbar py-6 sm:py-8" aria-live="polite" aria-label="Discovery conversation">
      ...
      <div className="flex-shrink-0 p-3 sm:p-4 md:p-6">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-xs text-deep-400 mt-2 sm:mt-3 text-center hidden sm:block">
